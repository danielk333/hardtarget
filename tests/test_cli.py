...
class TestCLI:
    def create_cfg(self, path: Path) -> Path:
        cfg_str = f"""
        [processing]
            n_ipp=2
            ipp_offset=0
    ...
    def test_analysis(self, method, sub_methods, get_data):
    ...
    def test_plot_analysed_data(self, method, monkeypatch, get_data):
        # mock away plt.show
    ...
    def test_inspect_analysed(self, method, get_data):
        # get data storage
        _, tmp_dir = get_data
    ...
    def test_plot_raw_data(self, monkeypatch, get_data):
        # mock away plt.show
        monkeypatch.setattr(plt, "show", lambda: None)
    ...
    def test_inspect_raw(self, get_data):
        # get data storage
        data_dir, _ = get_data
