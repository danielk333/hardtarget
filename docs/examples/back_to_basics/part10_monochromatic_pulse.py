...
from hardtarget.target_estimation.gmf.gmf_numpy import dft_taylor
...
errs = np.zeros((2, len(noise_sigmas), monte_carlo_samples))
...
axes[0].loglog(noise_sigmas, mu_f_err)
