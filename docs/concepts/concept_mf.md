...
This documents context and key concepts in **MF** processing
...
phase estimation** problem. We found a paper [@peleg1995discrete] which describes
...
signal's length in samples. The algorithm is called the _Discrete
Polynomial-phase Transform_, or DPT. Using the FFT to compute the DFTs, we name
this the Fast DPT, or _FDPT_.
