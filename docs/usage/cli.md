...
functionality is supported for **raw data** (supported by radardef) and [**mf**](../analyse/format_mf.md).

```bash
    $ hardtarget plot -h
    $ hardtarget plot raw -h
    $ hardtarget plot mf -h
    $ hardtarget plot raw /data/raw -s 2022-04-08T08:40:00 -e 2022-04-08T08:40:30
    $ hardtarget plot mf /data/mf -s 2022-04-08T08:40:00 -e 2022-04-08T08:40:30
```
...
## Analyse
Use the **analyse** tool to launch the analysis.

```bash
    $ hardtarget -v analyse /data/path --config cfg.ini --progress -o /data/
```
